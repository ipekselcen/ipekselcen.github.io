---
layout: default
title: "Research Highlight #2: Glioblastoma extrachromosomal DNA"
date: 2025-12-23
categories: editorial
tags: [research highlight]
---

## Tracking Glioblastoma’s Circular DNA at Single-Cell Resolution
Jiang et al., Cell Discovery (2024) | **[Read the paper →](https://www.nature.com/articles/s41421-025-00842-9)**
...
### The ecDNA Problem
Extrachromosomal DNA, or ecDNA, shows up in about 50-60% of glioblastomas, making it one of the most ecDNA-rich cancers<sup>1,2</sup>. These circular DNA molecules typically carry oncogenes such as EGFR, PDGFRA, and CDK4, which are all drivers of aggressive tumor growth. What makes ecDNA particularly dangerous is how it behaves during cell division. Unlike chromosomal DNA, which gets precisely copied and distributed to daughter cells, ecDNA segregates randomly<sup>3</sup>. One daughter cell might inherit many copies while another gets few or none, creating massive cell-to-cell variation in oncogene dosage. This heterogeneity fuels drug resistance and tumor evolution.
...
From a therapeutic standpoint, knowing which cells carry ecDNA and what those cells are doing opens new targeting strategies. Rather than just going after the oncogene itself (such as EGFR inhibitors that often fail in ecDNA-positive tumors<sup>4</sup>), you could potentially target the unique vulnerabilities of ecDNA-carrying cells or the mechanisms that maintain ecDNA.

<div class="callout callout-note">
<strong>🔖 Note</strong>
<p>The broader point is methodological: chromatin accessibility data, which many researchers are already generating, contains information about structural genomic alterations like ecDNA that we haven’t been systematically extracting. scCirclehunter provides a way to mine existing datasets for insights into tumor heterogeneity that would otherwise remain hidden.</p>
</div>
 
<div class="callout callout-important">
<strong>🔑 Important</strong>
<p>Bottom line: Glioblastoma’s circular DNA drives heterogeneity and treatment resistance, but we’ve lacked tools to track it cell-by-cell in patients. Single-cell chromatin accessibility provides a window into which cells carry ecDNA and how that shapes tumor behavior. As ecDNA-targeted therapies move toward the clinic, understanding its distribution at single-cell resolution will be critical for rational treatment design.</p>
</div>
